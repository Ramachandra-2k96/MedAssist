  ...
  return (
    <div className="min-h-screen w-full relative bg-background">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 50% 35% at 50% 0%, rgba(226, 232, 240, 0.12), transparent 60%), transparent",
        }}
      />
      ...
      >
        ...
        >
          ...
          <span className="font-bold text-lg">MedAssist</span>
        </a>
        ...
        <div className="flex items-center gap-4 z-20">
          {mounted && (
            <button
              ...
              className="p-2 rounded-lg bg-background/50 border border-border/50 hover:bg-background/80 transition-colors"
